<template>
  <div class="center-view">
    <div class="avatar">
      <img src="../images/avatar.png" class="avator-icon">
    ...
    <router-link to="/card" class="margin-set my-card">
      <span class="label">卖座卡</span>
    </router-link>
    <router-link to="/money" class="margin-set my-card">
      <span class="label">余额</span>
    </router-link>
    <router-link to="/setting" class="margin-set my-card">
